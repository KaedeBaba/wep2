...
class CalculatorApp(ft.Container):
        ...
        self.content = ft.Column(
            controls=[
                ...
                ft.Row(
                    controls=[
                        ActionButton(
                            text="MC", button_clicked=self.button_clicked
                        ),
                        ActionButton(
                            text="MR", button_clicked=self.button_clicked
                        ),
                    ]
                ),
                ft.Row(
    ...
    def button_clicked(self, e):
        ...
        if self.result.value == "Error" or data == "AC":
            ...
            print(f"Memory after MC: {self.memory}")

        elif data in ("MR"):
            self.result.value = str(self.memory)
            print(f"Memory recalled (MR): {self.memory}")

        elif data == "π":
            self.result.value = str(3.141592653589793)
